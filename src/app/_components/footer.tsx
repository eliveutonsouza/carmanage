        ...
        <div className="flex justify-between  flex-wrap -mx-4">
          <div className="px-4">
            <div className="w-full mb-10">
              <Link href="/" className="inline-block max-w-[160px] mb-6">
                <Image
                  src="/logotipo-full.svg"
                  alt="logo"
                  width={150}
                  height={150}
                  quality={100}
              ...
              <div className="flex items-center -mx-3">
                <Link href="#" className="px-3 text-gray-400 hover:text-white">
                  <svg
                    width="10"
                    height="18"
                    viewBox="0 0 10 18"
            ...
            <div className="w-full md:w-2/3 lg:w-1/2 px-4">
              <div className="my-1">
                <div className="flex items-center justify-center md:justify-start -mx-3">
                  <Link
                    href="/privacy-policy"
                    className="text-base text-gray-300 hover:text-primary px-3"
                  >
